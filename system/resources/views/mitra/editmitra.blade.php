...
<div class="container-fluid">
    ...
    <form action="{{url('updatemitra', $mitra->id)}}" method="POST" enctype="multipart/form-data">
    	@csrf
        @method("PUT") 
	    <div class="row">
	    	<div class="col-lg-12 col-12">
	    		<div class="card card-primary">
	    			...
	    			<div class="card-body">
	    				<input type="text" name="id_user" value="{{$mitra->id_user}}" hidden="">
	    				...
	    				<div class="form-group row">
	    					...
	    					<div class="col-sm-10">
	    						...
	    						<input type="confir_password" class="form-control" name="confir_password" value="{{$mitra->confir_password}}">
	    					</div>
	    				</div> 
	    				<div class="form-group row">
