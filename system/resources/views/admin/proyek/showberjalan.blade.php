                            ...
                            <ul class="list-style9 no-margin">
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-9">
                                            <p>Tahun {{ $project->mitra->tahun_operasi }}</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-9">
                                            <p><a href="">{{ $project->mitra->website }}</a></p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="list-style9 no-margin">
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="text-align: justify;">
                                            <p style="text-align: justify;">{!! nl2br($project->deskripsi_masalah) !!}</p>
                                        </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <i class="fas fa-bookmark text-orange"></i>
                                            <strong style="color: black;">Level Kompleksitas:</strong>
                                        </div>
                                        <div class="col-md-4">
                                            <p>{{ $project->level_kompleksitas }}</p>
                                        </div>

                                        <div class="col-md-2">
                                            <i class="fas fa-bookmark text-orange"></i>
                                            <strong style="color: black;">Program Studi Yang Terlibat:</strong>
                                        </div>
                                        <div class="col-md-2">
                                            <p>{{ $project->prodi_terlibat }}</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <i class="fas fa-bookmark text-orange"></i>
                                            <strong style="color: black;">Manajer Proyek Internal:</strong>
                                        </div>
                                        <div class="col-md-4">
                                            <p>{{ $project->mp_internal }}</p>
                                        </div>

                                        <div class="col-md-2">
                                            <i class="fas fa-bookmark text-orange"></i>
                                            <strong style="color: black;">Manajer Proyek Eksternal:</strong>
                                        </div>
                                        <div class="col-md-2">
                                            <p>{{ $project->mp_eksternal }}</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <i class="fas fa-bookmark text-orange"></i>
                                            <strong style="color: black;">Tahun Pelaksanaan:</strong>
                                        </div>
                                        <div class="col-md-4">
                                            <p>{{ $project->tahun_pelaksana }}</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
